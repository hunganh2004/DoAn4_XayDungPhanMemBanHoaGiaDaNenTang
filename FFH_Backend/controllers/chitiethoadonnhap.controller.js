...
import service from '../services/chitiethoadonnhap.service.js'
...
class ChitiethoadonnhapController {
    ...
    insert(req, res) {
        const chitiethoadonnhap = req.body
        service.insert(chitiethoadonnhap, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
        const chitiethoadonnhap = req.body
        // const id = req.params.id
        service.update(chitiethoadonnhap, (result) => {
            res.send(result)
        })
    }
    delete(req, res) {
...
export default new ChitiethoadonnhapController(service)